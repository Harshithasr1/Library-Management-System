...
public class audiovideo extends JFrame implements ActionListener{
    ...
    public audiovideo() {
        super("Add Audio/Video");
        setBounds(600, 200, 500, 410);
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            conn con = new conn();
            if(ae.getSource() == b1){
                String sql = "insert into audiovideo(item_id, category, name, isbn, author, price) values(?, ?, ?, ?, ?, ?)";
